...
import 'package:hal_labeling_pre/widgets/task_column.dart';
...
class TagInput extends StatefulWidget {
  ...
  TagInput({Key key, @required this.data});
  static final ROUTE = '/add';
  ...
  Widget build(BuildContext context) {
    ...
    */
    ...
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(
        title: Text('태그', style: TextStyle(color: Colors.white)),
        centerTitle: true,
